...
const Preloader = () => {
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-[#0f0f11] z-50">
      {/* Text message */}
      <motion.div
        className="text-white text-xl text-center max-w-xs font-medium"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.8 }}
      >
        <TypewriterEffect text="One moment, putting things together..." />
      </motion.div>
    </div>
  );
};
...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-[#ff5757]/10 to-[#b91c1c]/10 blur-3xl animate-pulse" />
    <div className="absolute inset-0 bg-gradient-to-tr from-[#ff5757]/5 via-transparent to-[#b91c1c]/5 blur-2xl animate-float" />
  </div>
);
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              <motion.div
                ...
                style={{
                  WebkitFilter: "drop-shadow(0 0 15px rgba(255, 87, 87, 0.3))",
                  filter: "drop-shadow(0 0 15px rgba(255, 87, 87, 0.3))"
                }}
              >
                <Preloader />
              </motion.div>
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="www.umeshpatil.com" />
                    </span>
                  </div>
                </a> */}
              </motion.div>
